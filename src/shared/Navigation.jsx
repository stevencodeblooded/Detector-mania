    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 flex items-center justify-between relative">
        ...
        <ul className="hidden xl:flex items-center gap-3 uppercase font-semibold text-xs">
          ...
          <li className="flex items-center gap-1">
            ...
            <p className="text-xs p-1 rounded-md bg-yellow-100 flex items-center gap-1">
              New <img className="w-3" src={fire} alt="" />
            </p>
          </li>
          <li>
            <NavLink
        ...
        <div className="flex items-center gap-5 text-xl relative">
          ...
          <div className="relative">
            ...
            {notificationsVisible && (
              <div
                className={`absolute z-20 top-full right-0 mt-2 w-64 border rounded-md shadow-lg ${
                  darkMode
          ...
          <div
            className={`absolute top-0 right-5 flex items-center transition-transform duration-300 ease-in-out ${
              searchVisible ? "translate-x-0" : "translate-x-full"
            }`}
          >
            <FontAwesomeIcon
            ...
            <input
              ...
              className={`p-2 pl-10 border rounded-l-lg outline-none transition-transform duration-300 ease-in-out ${
                searchVisible
            ...
            />
            <button
              className={`p-2 text-white bg-red-500 rounded-r-lg transition-transform duration-300 ease-in-out ${
                searchVisible
                  ? "opacity-100 translate-x-0"
                  : "hidden"
              }`}
          ...
          <IoGridOutline
            className="bg-emerald-700 mr-10 text-white p-2 text-4xl rounded-md cursor-pointer"
      ...
      {mobileNavLinks && (
        <div className="fixed inset-0 z-20 flex">
          ...
          ></div>
          <div
            className={`absolute top-0 right-0 w-full sm:w-3/4 md:w-1/2 lg:w-1/3 h-full p-5 shadow-lg transform transition-transform duration-300 ease-in-out translate-x-0 ${
              darkMode ? "bg-gray-800 text-white" : "bg-white text-gray-900"
            }`}
          >
            <h4
              className="text-3xl absolute top-12 right-12 cursor-pointer"
              onClick={hideMobileLinks}
            >
              <FontAwesomeIcon icon={faX} />
            </h4>
            <ul className="flex flex-col px-6 text-xl mt-32 gap-3 uppercase font-semibold ">
              ...
              <li className="flex items-center gap-2">
                <p>
                  <a href={"#recension"} onClick={hideMobileLinks}>
                    Recension
                  </a>
                </p>
                <p className="text-xs p-1 rounded-md bg-yellow-100 text-black flex items-center gap-1">
                  <img className="w-3" src={fire} alt="" />
                  New
                </p>
              </li>
              <li>
