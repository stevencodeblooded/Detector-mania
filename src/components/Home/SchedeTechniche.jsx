      ...
      <Slider ref={sliderRef} {...settings} className="pt-12">
        {[1, 2, 3, 4, 5].map((item) => (
          <div key={item} className="px-2">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer border-4 border-emerald-300 hover:border-emerald-400 transition-all">
              <img
              ...
              <div className="flex flex-col items-center gap-3 p-3 ">
                ...
                <button className=" bg-emerald-500 hover:bg-emerald-600 w-full text-white uppercase font-semibold py-2 px-4 rounded-xl transition-all">Vai alla scheda</button>
              </div>
            </div>
          </div>
        ))}
